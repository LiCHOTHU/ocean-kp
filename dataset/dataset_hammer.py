...
class Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        elif self.consecutive_frames_only:
            frame_idx_fr = frame_idx
        ...
        rgb_path_fr = os.path.join(self.dataset_root, f'{vid_idx:06d}', f'{frame_idx_fr:08d}.jpg')
        depth_path_fr = os.path.join(self.dataset_root, f'{vid_idx:06d}', f'{frame_idx_fr:08d}d.tiff')
        rgb_path_to = os.path.join(self.dataset_root, f'{vid_idx:06d}', f'{frame_idx_to:08d}.jpg')
        depth_path_to = os.path.join(self.dataset_root, f'{vid_idx:06d}', f'{frame_idx_to:08d}d.tiff')
        ...
        if self.set_scale_from_mesh:
            joint_mesh = vid_data['vert'][frame_idx_fr,:,:]
        ...
        quadric = torch.Tensor(vid_data['qruadric'])
